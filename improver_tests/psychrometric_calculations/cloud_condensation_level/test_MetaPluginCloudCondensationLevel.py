...
@patch('improver.psychrometric_calculations.psychrometric_calculations.HumidityMixingRatio')
@patch('improver.psychrometric_calculations.cloud_condensation_level.CloudCondensationLevel')
def test_basic(mock_CloudCondensationLevel, mock_HumidityMixingRatio):
    ...
    mock_HumidityMixingRatio_instance = mock_HumidityMixingRatio.return_value
    ...
    mock_HumidityMixingRatio().assert_called_once_with(sentinel.cube1, sentinel.cube2, sentinel.cube3)
    mock_CloudCondensationLevel().assert_called_once_with(mock_HumidityMixingRatio().temperature,
