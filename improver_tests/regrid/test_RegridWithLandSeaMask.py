...
def test_regrid_nearest_with_mask_2():
    ...
    expected_results = np.array(
        [
            [0.0, 1.0, 1.0, 1.0, 2.0, 2.0, 2.0, 3.0, 3.0, 3.0, 3.0],
            [0.0, 1.0, 1.0, 1.0, 7.0, 2.0, 7.0, 3.0, 3.0, 3.0, 3.0],
            [5.0, 6.0, 6.0, 6.0, 7.0, 7.0, 7.0, 8.0, 8.0, 8.0, 8.0],
            [5.0, 6.0, 6.0, 6.0, 7.0, 7.0, 7.0, 8.0, 8.0, 8.0, 9.0],
            [10.0, 11.0, 11.0, 11.0, 7.0, 7.0, 7.0, 8.0, 8.0, 8.0, 14.0],
            [10.0, 11.0, 11.0, 11.0, 12.0, 12.0, 12.0, 13.0, 13.0, 13.0, 14.0],
            [10.0, 11.0, 11.0, 11.0, 12.0, 12.0, 7.0, 13.0, 13.0, 13.0, 14.0],
            [15.0, 16.0, 16.0, 16.0, 17.0, 17.0, 7.0, 18.0, 18.0, 18.0, 19.0],
        ]
    )
    print(regrid_nearest_with_mask.data)
