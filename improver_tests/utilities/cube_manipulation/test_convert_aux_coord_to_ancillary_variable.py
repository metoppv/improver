...
class Test_convert_aux_coord_to_ancillary_variable(unittest.TestCase):
    ...
    def test_conversion_with_aux_coord(self):
        ...
        result = convert_aux_coord_to_ancillary_variable(
            self.cube_with_aux_coord, self.aux_coord_name, self.ancillary_var_name
        )
    ...
    def test_conversion_with_no_aux_coord(self):
        ...
        with self.assertRaises(ValueError):
            convert_aux_coord_to_ancillary_variable(
                self.cube_without_aux_coord,
                self.aux_coord_name,
                self.ancillary_var_name,
            )
