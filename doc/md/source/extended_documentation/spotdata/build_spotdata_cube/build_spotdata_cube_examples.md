...
where the neighbour_selection dimension coordinate is necessarily
numeric, but the string names of the methods can be found in the
associated neighbour_selection_method_name auxiliary coordinate, e.g.:
...
of the elements of this coordinate can be found in the
grid_attribute_key auxiliary coordinate, e.g.:
